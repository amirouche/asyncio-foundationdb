...
/*
 * Stripped-down version of the official fdb_c.h for use with CFFI
 * set_source().  All preprocessor guards, DLLEXPORT, WARN_UNUSED_RESULT,
 * and #include directives have been removed so that the C compiler
 * sees plain declarations.
 *
